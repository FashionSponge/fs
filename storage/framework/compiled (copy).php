...
interface Dispatcher
{
    ...
    public function dispatchFrom($command, ArrayAccess $source, $extras = array());
...
class Guard implements GuardContract
{
    ...
    public function __construct(UserProviderInterface $provider, SessionInterface $session, Request $request = null)
    {
...
class Dispatcher implements DispatcherContract, QueueingDispatcher, HandlerResolver
{
    ...
    protected function marshal($command, ArrayAccess $source, $extras = array())
    {
        $injected = array();
